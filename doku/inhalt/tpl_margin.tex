...
%\lstinputlisting[language={[LaTeX]{TeX}},style=block,float={htb},caption={Anzeige des Satzspiegels},label={lst:tpl:margin_showframe}]{code/tpl_margin_showframe.tex}
