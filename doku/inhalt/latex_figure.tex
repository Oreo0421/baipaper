Abbildungen können durch das Kommand \lstinline+\includegraphics+ aus dem Paket
\texttt{graphicx} eingebunden werden. Die Abbildung muss dafür als Grafikdatei
vorliegen. Legen Sie Abbildungen in dem Unterverzeichnis \texttt{bilder} ab
(siehe Abschnitt~\ref{sec:vorlage:dir}). Verwenden Sie je nach Anwendungsfall
die folgenden Bildformate.
...
\item[PDF] Technische Zeichnungen, Grafiken, Diagramme, etc. -- Im Allgemeinen
  ...
  und Flächen und können und Qualitätsverlust vergrößert oder Verkleinert
...
\item[PNG] Screenshots, computergenerierte Abbildungen (3D-Visualisierungen,
  ...
  schachbrettartigen Anfordnung kleinster Pixel, die unterschiedliche gefärbt
  ...
  Bildinformationen werden bei der Speicherung nicht verändert. Es eigenet sich
...
\item[JPEG] Fotografien, eingescannte Bildvorlagen -- Hierbei handelt es sich
  ...
  Abbildungen mit starke Kontrasten, feinen Linien oder stark gesättigten
...
\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{bilder/!\lara{Dateiname}!}
...
Bei der \texttt{figure}-Umgebung handelt es sich um eine Gleitumgebungen. Die
