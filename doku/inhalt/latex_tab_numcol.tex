...
\begin{table}
\centering
\input{code/latex_tab_numcol}
\caption{Bahnelemente der Planeten zur Epoche J2000.0}
\label{tab:latex:tab:numcol}
\end{table}

\lstinputlisting[language={[LaTeX]{TeX}},style=block,float,caption={Tabelle mit ausgerichteten Zahlenspalten},label={lst:latex:tab:numcol}]{code/latex_tab_numcol.tex}
