...
\lstinputlisting[language={[LaTeX]{TeX}},style=block,escapechar=\!,float,caption={Einfache Überschriften},label={lst:final:simplesection}]{code/final_simplesection.tex}
