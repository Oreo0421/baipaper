...
\lstinputlisting[language={[LaTeX]{TeX}},style=block,escapechar=\!,float={htb},caption={Aufnahme zusätzlicher Verzeichniseinträge},label={lst:final:addcontentsline},morekeywords={chapter,subsection}]{code/final_addcontentsline}
