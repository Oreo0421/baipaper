...
im Prinzip das selbe wie im vorangegangen Abschnitt. Es kommt lediglich ein
...
\lstinputlisting[language={[LaTeX]{TeX}},style=block,escapechar=\!,float={htb},caption={Ehrenwörtliche Erklärung},label={lst:final:erklaerung}]{code/final_erklaerung.tex}
