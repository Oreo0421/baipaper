...
Listing~\ref{lst:latex:literatur:bibtexentry} zeigt einen beispielhaften Eintrag für
dieses Handbuch.

\lstinputlisting[language=BibTeX,style=block,float,caption={Ein \hologo{BibTeX}-Eintrag},label={lst:latex:literatur:bibtexentry}]{code/latex_literatur_bibtexentry.bib}
