...
\lstinputlisting[language={[LaTeX]{TeX}},style=block,float,caption={Abweichende Nummierierung für den Vorspann},label={lst:final:fancyhdr2}]{code/final_fancyhdr2.tex}
