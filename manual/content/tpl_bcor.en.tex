...
of sheets~$n$. Here, the grammage in the unit \unit{\gram\per\metre\squared}
into the size equation. The result of the formula corresponds to the thickness
in millimetres.
%
\begin{equation}
...
therefore has a thickness of \qty{4}{\milli\metre} for paper with a thickness
of \qty{80}{\gram\per\metre\squared}. However, a usual comb binding has a width
of \qty{6}{\milli\metre}, so that the correction must be increased to this
value.
